    ...
    <body>
      <header class="header">
        <div class="header-content">
          <img src="/images/allaround-athlete-logo.png" alt="AllAroundAthlete Logo" style="height:72px;width:auto;margin-right:22px;background:transparent;border-radius:6px;display:block;">
          <span style="font-size:2em;font-weight:800;color:#4f8cff;letter-spacing:2px;text-transform:uppercase;margin-right:32px;">ALL AROUND ATHLETE</span>
